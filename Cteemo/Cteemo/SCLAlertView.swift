...
public enum SCLAlertViewStyle {
    case Success, Error, Notice, Warning, Info, Edit,Cteemo
}
...
public class SCLAlertView: UIViewController {
    ...
    public func showCteemo(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .Cteemo)
    }
